<h3>Документация по проекту "Программа для создания изображений на основе TKinter"</h3>
<h4>Программа для создания изображений на основе TKinter</h4>
...
<h4>Добавлено:</h4>
<b>- Выбор размера кисти из списка
- Инструмент "Ластик"
- Пипетка для выбора цвета с холста
- Горячие клавиши для быстрых действий: <Сохранение изображения>(ctrl+s), <Выбор цвета кисти>(ctrl+c)
